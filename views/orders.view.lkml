view: orders {
  ...
  dimension: start_fiscal_year {
    type: date
    sql:'2018-10-01 00:00:00' ;;
  }
  dimension: end_fiscal_year {
    type: date
    sql:'2019-09-30 11:59:59' ;;
  }

  dimension: is_before_mtd{
  type: yesno
  sql: (DAYOFYEAR(${created_time}) < DAYOFYEAR(CURRENT_TIMESTAMP) AND

        (DAYOFYEAR(${created_time}) > ${start_fiscal_year} )
